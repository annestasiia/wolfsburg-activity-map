...
const CACHE_PREFIX = 'wolfsburg_boundary_v1_'
const OVERPASS_URL = 'https://overpass-api.de/api/interpreter'
const TIMEOUT_MS   = 15000

const OVERPASS_QUERIES = {
  'Stadtmitte':
    '[out:json];relation(3879168);(._;>;);out body;',
  'Mitte-West':
    '[out:json];relation(3879170);(._;>;);out body;',
  'Kästorf-Sandkamp':
    '[out:json];area["name"="Wolfsburg"]["place"="city"]->.city;rel(area.city)["name"~"Sandkamp"]["boundary"="administrative"];(._;>;);out body;',
  'Nordstadt':
    '[out:json];relation(3879169);(._;>;);out body;',
  'Vorsfelde':
    '[out:json];relation(1263350);(._;>;);out body;',
  'Neuhaus-Reislingen':
    '[out:json];relation(3879173);(._;>;);out body;',
}
